...
int main(int argc, char *argv[]) {
  ...
  switch (test_number) {
    ...
    case 15:
      ...
      EXPECT_CONTAINS(
          "Core 7 is currently assigned 0 task(s) and has completed 0 "
          "task(s).");
      break;
    ...
    case 16:
      ...
      EXPECT_CONTAINS(
          "Added task with ID 0, task time of 10, and priority of 10.");
      EXPECT_CONTAINS(
          "Added task with ID 1, task time of 10, and priority of 9.");
      EXPECT_CONTAINS("Removed task 0 which was executed after waiting 0.");
    ...
    case 18:
      ...
      EXPECT_CONTAINS(
          ...
          "task(s).");
      EXPECT_CONTAINS(
          "Added task with ID 1, task time of 2, and priority of 10.");
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 1 task(s) and has completed 0 "
          "task(s).");
      EXPECT_CONTAINS(
          ...
          "task(s).");
      EXPECT_CONTAINS(
          "Added task with ID 2, task time of 2, and priority of 9.");
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 1 task(s) and has completed 0 "
          "task(s).");
      EXPECT_CONTAINS(
      ...
      EXPECT_CONTAINS("SimScheduler clock is now 10.");
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 0 task(s) and has completed 1 "
          "task(s).");
      EXPECT_CONTAINS(
          "Core 1 is currently assigned 0 task(s) and has completed 2 "
          "task(s).");
    ...
    case 19:
      ...
      EXPECT_CONTAINS(
          "Added task with ID 1, task time of 10, and priority of 1.");
      EXPECT_CONTAINS("Removed task 1 which was executed after waiting 0.");
    ...
    case 20:
      ...
      EXPECT_CONTAINS(
          ...
          "task(s).");
      EXPECT_CONTAINS(
          "Added task with ID 0, task time of 10, and priority of 4.");
      EXPECT_CONTAINS(
          "Added task with ID 1, task time of 10, and priority of 3.");
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 1 task(s) and has completed 0 "
          "task(s).");
      EXPECT_CONTAINS(
          ...
          "task(s).");
      EXPECT_CONTAINS(
          "Added task with ID 2, task time of 10, and priority of 2.");
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 2 task(s) and has completed 0 "
          "task(s).");
      EXPECT_CONTAINS(
          "Added task with ID 3, task time of 10, and priority of 1.");
      EXPECT_CONTAINS(
          "Core 1 is currently assigned 2 task(s) and has completed 0 "
          "task(s).");
      EXPECT_CONTAINS("Removed task 0 which was executed after waiting 0.");
    ...
    case 22:
      ...
      EXPECT_CONTAINS(
          "Added task with ID 2, task time of 10, and priority of 2.");
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 3 task(s) and has completed 0 "
          "task(s).");
      EXPECT_CONTAINS(
          "Added task with ID 3, task time of 10, and priority of 1.");
      EXPECT_CONTAINS("Removed task 3 which was executed after waiting 0.");
      ...
      EXPECT_CONTAINS(
          "Core 0 is currently assigned 0 task(s) and has completed 4 "
          "task(s).");
      EXPECT_CONTAINS("Removed core 0.");
      EXPECT_CONTAINS("Removed scheduler.");
      EXPECT_CONTAINS("Program ended.");
